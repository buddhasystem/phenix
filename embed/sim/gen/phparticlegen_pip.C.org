...
//
void
phparticlegen_pip(const int nevents = 10, const char *outputname = "phparticlegen.root")
{
  ...
  //ss->GetGenerator()->SetParameter("pid",-211);	// pip
  //ss->GetGenerator()->SetParameter("pid",11);	// em
  ss->GetGenerator()->SetParameter("pid",-11);	// ep
